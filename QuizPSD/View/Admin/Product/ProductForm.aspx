<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProductForm.aspx.cs" Inherits="QuizPSD.View.Admin.Product.ProductForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <div>
            <asp:Button ID="btnSubmit" runat="server" Text="Add Product" OnClick="AddProduct_Click" />
